...
btn.onclick = () => {
    ...
    if(userEnteredAmount < 1 || isNaN(userEnteredAmount)) {
        ...
        resultTag.textContent = "Error: Somente valores numéricos maiores que 0 são permitidos.";
    }
    else {
        numberInputField.style.border = "1px solid gray";
        resultTag.style.color = "black";
        btn.textContent = "Processando: tenha paciência...";
...
function convertAmount(amount) {
    ...
    fetchData(`https://v6.exchangerate-api.com/v6/${api}/latest/USD`)
        ...
        .catch(error => console.log(`Informações adicionais sobre erro: ${error}`));
}
